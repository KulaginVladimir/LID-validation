...
gmsh.model.geo.addPoint(0, 0, 0, 5e-5, 1)  # left bottom Cu node
gmsh.model.geo.addPoint(R, 0, 0, 5e-5, 2)  # right bottom Cu node
gmsh.model.geo.addPoint(R, L_Cu, 0, 5e-7, 3)  # right top Cu node
gmsh.model.geo.addPoint(R, L_Cu + L_W, 0, 1e-6, 4)  # right top W node
gmsh.model.geo.addPoint(0, L_Cu + L_W, 0, 1e-9, 5)  # left top W node
gmsh.model.geo.addPoint(0, L_Cu, 0, 5e-8, 6)  # left top Cu node
...
gmsh.model.mesh.field.setNumber(bl, "Size", 1e-9)
gmsh.model.mesh.field.setNumber(bl, "Ratio", 1.1)
gmsh.model.mesh.field.setNumber(bl, "Quads", 0)
gmsh.model.mesh.field.setNumber(bl, "Thickness", 5e-7)
