...
model.boundary_conditions = [
    ...
    # F.DirichletBC(surfaces=[4,5,6], value=300, field="T"),
...
model.dt = F.Stepsize(
    ...
    max_stepsize=lambda t: 5e-5 if t < 2.5e-3 else 5e-4,
    dt_min=1e-8,
)
...
XDMF = [
    #F.XDMFExport(
    #    field="T", filename="./res/T.xdmf", checkpoint=True, label="T", mode="last"
    #),
    F.XDMFExport(
        field="retention",
