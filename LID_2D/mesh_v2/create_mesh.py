...
gmsh.model.geo.addPoint(0, L_Cu, 0, 5e-7, 6)  # left top Cu node
...
gmsh.model.mesh.field.setNumber(bl, "Thickness", 1e-7)
gmsh.model.mesh.field.setNumber(bl, "SizeFar", 5e-7)
