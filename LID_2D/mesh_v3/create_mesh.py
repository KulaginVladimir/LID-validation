...
gmsh.model.geo.addPoint(0, L_Cu, 0, 1e-7, 6)  # left top Cu node
...
gmsh.model.mesh.field.setNumber(bl, "Size", 2.5e-9)
gmsh.model.mesh.field.setNumber(bl, "Ratio", 1.1)
gmsh.model.mesh.field.setNumber(bl, "Quads", 0)
gmsh.model.mesh.field.setNumber(bl, "Thickness", 1.5e-7)
gmsh.model.mesh.field.setNumber(bl, "SizeFar", 2.5e-7)
