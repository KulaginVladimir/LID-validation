...
derived_quantities = F.DerivedQuantities(
    ...
    show_units=True,
    filename=f"/mnt/pool/6/vvkulagin/results_2D/{duration}_E{E0:.3f}/derived_quantities.csv",
...
XDMF = [
    ...
    F.XDMFExport(
        field="retention",
        filename=f"/mnt/pool/6/vvkulagin/results_2D/{duration}_E{E0:.3f}/retention.xdmf",
        checkpoint=True,
        label="retention",
        mode="last",
    ),
